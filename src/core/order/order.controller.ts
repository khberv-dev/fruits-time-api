...
const orderExample = {
  ...
  status: 'created',
  type: 'delivery',
  branch: { id: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', name: 'Chilonzor', address: "Bunyodkor ko'chasi 1" },
...
export class OrderController {
  ...
  @ApiOperation({
    ...
    description:
      ...
      'cost when `type` is `delivery`, a breakdown of every discount applied by name (referral tier and/or any ' +
